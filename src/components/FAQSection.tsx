...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Цены начинаются от 200₽ за реферат, 400-800₽ за курсовую работу и 1000-3000₽ за дипломную работу. Это в 10 раз дешевле, чем заказывать работу с нуля у авторов.'
  },
  {
  ...
  },
  {
    ...
    answer: 'При регистрации вы получаете 1000 баллов бесплатно. 1 балл = 1 рубль. Баллы можно пополнить картой, заработать за загрузку своих работ или получить по реферальной программе.'
  },
  {
