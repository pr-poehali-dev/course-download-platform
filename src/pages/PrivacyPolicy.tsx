        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <p>
                Оператором персональных данных является: самозанятый гражданин Гагарская Елизавета Александровна, ИНН 290540407146, email: gagarskaal@gmail.com. 
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <p className="mt-4">
                Для реализации своих прав свяжитесь с нами по email: gagarskaal@gmail.com или через форму техподдержки.
              </p>
            </CardContent>
          </Card>
