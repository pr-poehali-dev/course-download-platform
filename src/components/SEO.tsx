...
const DEFAULT_SEO = {
  ...
  keywords: 'примеры работ для ознакомления, референсные работы для изучения, база примеров курсовых, образцы оформления по ГОСТ, учебные материалы для справки, примеры дипломных работ для изучения, справочные материалы для студентов 18+, изучение структуры работ, примеры оформления документов, методические материалы для изучения',
