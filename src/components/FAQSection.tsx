...
const faqData: FAQItem[] = [
  {
    ...
    answer: 'Зарегистрируйтесь на платформе, пополните баланс или загрузите свою работу. Выберите материал в каталоге, оплатите баллами, и мгновенно скачайте архив с файлами. Поддерживаются форматы: DOCX, PDF, DWG, CDW и другие.'
  },
  {
  ...
  },
  {
    ...
    answer: '1 балл = 5 рублей при покупке пакетов. Баллы можно пополнить картой в разделе "Баланс", заработать за загрузку своих работ или получить по реферальной программе. По реферальной ссылке: новый пользователь получает 500 баллов, а вы — 250 баллов.'
  },
  {
