...
const FAKE_NAMES = [
  'Александр Козлов', 'Мария Васильева', 'Дмитрий Смирнов', 'Елена Петрова', 'Иван Морозов',
  'Анна Лебедева', 'Сергей Титов', 'Ольга Романова', 'Максим Борисов', 'Татьяна Новикова',
  'Андрей Жуков', 'Наталья Данилова', 'Павел Кузнецов', 'Екатерина Соколова', 'Владимир Иванов',
  'Юлия Федорова', 'Алексей Михайлов', 'Виктория Попова', 'Николай Волков', 'Дарья Орлова',
  'Константин Белов', 'Светлана Егорова', 'Роман Павлов', 'Ирина Захарова', 'Артём Григорьев'
];
