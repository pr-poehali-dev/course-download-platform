...
export default function TestExitModal() {
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-red-500 hover:bg-red-600 text-white font-bold px-4 py-2 rounded-full shadow-2xl flex items-center gap-2 animate-pulse"
      >
