...
const DEFAULT_SEO = {
  title: 'Tech Forma — Маркетплейс студенческих работ с ИИ-помощником',
  description: 'Каталог курсовых, дипломов, чертежей. TechMentor AI в Telegram. Маркетплейс для студентов. Покупай за баллы, продавай свои работы.',
  keywords: 'курсовые работы, дипломы, рефераты, студенческие работы купить, чертежи, ИИ помощник, telegram бот для учебы, маркетплейс работ',
