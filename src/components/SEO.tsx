...
const DEFAULT_SEO = {
  title: 'Tech Forma — База референсных работ для студентов',
  description: '500+ примеров студенческих работ для ознакомления: курсовые, дипломы, лабораторные, чертежи по техническим дисциплинам. Изучайте структуру и оформление работ по ГОСТ.',
  keywords: 'примеры работ для ознакомления, референсные работы, база студенческих работ, примеры курсовых работ, образцы дипломных проектов, примеры лабораторных работ, учебные материалы для студентов, примеры оформления по ГОСТ, технические работы, справочные материалы для учебы',
