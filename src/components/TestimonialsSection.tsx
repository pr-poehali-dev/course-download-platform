...
const testimonials = [
  {
    id: 1,
    name: 'Анна Кодова',
    role: 'Студентка 3 курса МГУ',
    content: 'Купила курсовую по программированию за 600 баллов. Все оформлено идеально, препод принял с первого раза. Сэкономила 2 недели работы!',
    rating: 5,
  ...
  },
  {
    id: 2,
    name: 'Дмитрий Технов',
    role: 'Студент 5 курса МГТУ',
    content: 'Скачал дипломную за 1500 баллов — защитился на отлично! Все расчеты правильные, оформление по ГОСТу. Рекомендую!',
    rating: 5,
  ...
  {
    id: 3,
    name: 'Елена Студентова',
    role: 'Студентка 2 курса СПбГУ',
    content: 'Купила реферат по психологии всего за 100 баллов. Получила доступ за 2 минуты! Цена смешная, буду брать еще.',
    rating: 5,
  ...
  {
    id: 4,
    name: 'Александр Боссов',
    role: 'Магистрант ВШЭ',
    content: 'Магистерская за 3000 баллов — лучшее что я нашел. Научный руководитель был в восторге от глубины проработки. Спасибо!',
    rating: 5,
  ...
  {
    id: 5,
    name: 'Мария Студенцова',
    role: 'Студентка 4 курса РУДН',
    content: 'Покупаю работы уже полгода — ни разу не подвели! Техподдержка всегда помогает выбрать подходящую работу. Очень довольна!',
    rating: 5,
  ...
  {
    id: 6,
    name: 'Игорь Профессионалов',
    role: 'Студент 3 курса МФТИ',
    content: 'Скачал чертежи по инженерной графике — все по ГОСТу! Преподаватель даже удивился качеству. Цена копеечная!',
    rating: 5,
  ...
  },
  {
    id: 7,
    name: 'Ольга Датанова',
    role: 'Студентка 2 курса НИУ ВШЭ',
    content: 'Нашла курсовую по Data Science за 600 баллов. Отличные примеры кода и анализа данных. Сервис топ!',
    rating: 5,
  ...
  {
    id: 8,
    name: 'Максим Лётчиков',
    role: 'Студент 3 курса МАИ',
    content: 'Скачал курсовую по аэродинамике за 600 баллов. Все расчеты правильные, препод поставил 5. Отличный сервис!',
    rating: 5,
