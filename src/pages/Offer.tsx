        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Обеспечивать работоспособность платформы (кроме технических работ)</li>
          ...
          <Card className="border-2 border-red-500/30 bg-red-50/20">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p className="font-semibold text-foreground">
                7.1. Гарантии пользователя при загрузке материалов
              </p>
              <p>
                Загружая материалы на Платформу, Пользователь гарантирует, что:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Является автором загружаемого материала или обладает всеми необходимыми правами на его публикацию и распространение</li>
                <li>Загружаемый контент не нарушает авторские права, смежные права, права на товарные знаки или иные права третьих лиц</li>
                <li>Материал не содержит конфиденциальной информации, полученной незаконным путем</li>
                <li>Предоставляет Платформе право на размещение и распространение материала среди пользователей</li>
              </ul>

              <div className="bg-red-100 border-l-4 border-red-500 p-4 mt-4">
                <p className="font-bold text-red-800 mb-2">
                  ⚠️ ВНИМАНИЕ: Запрет на пиратский контент
                </p>
                <p className="text-sm text-red-700">
                  Категорически запрещена загрузка материалов, скачанных из других источников, 
                  платных курсов третьих лиц, учебников издательств без разрешения, работ других 
                  студентов без их согласия. Нарушение приведет к блокировке аккаунта и передаче 
                  данных правообладателю.
                </p>
              </div>

              <p className="font-semibold text-foreground mt-4">
                7.2. Процедура обработки жалоб правообладателей (DMCA Takedown)
              </p>
              <p>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Ваши контактные данные (ФИО, email, телефон)</li>
                <li>Документы, подтверждающие ваши права (свидетельство об авторстве, договор и т.д.)</li>
                <li>Прямую ссылку на материал, нарушающий права</li>
                <li>Описание нарушения и требуемые действия (удаление, блокировка)</li>
              </ul>

              <p className="mt-3">
                <strong className="text-foreground">Срок рассмотрения:</strong> В течение 24 часов с момента получения обоснованной жалобы 
                материал будет удален, а аккаунт нарушителя заблокирован.
              </p>

              <p className="font-semibold text-foreground mt-4">
                7.3. Последствия нарушения авторских прав
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Первое нарушение:</strong> предупреждение + удаление материала</li>
                <li><strong>Повторное нарушение:</strong> временная блокировка аккаунта на 30 дней</li>
                <li><strong>Систематические нарушения:</strong> перманентная блокировка без возврата баллов</li>
                <li><strong>Претензии правообладателей:</strong> передача контактных данных нарушителя, возмещение убытков за счет нарушителя</li>
              </ul>

              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mt-4">
                <p className="font-bold text-yellow-800 mb-2">
                  📋 Снятие ответственности Платформы
                </p>
                <p className="text-sm text-yellow-700">
                  Платформа выступает только как технический посредник и НЕ осуществляет 
                  предварительную проверку загружаемых материалов на предмет нарушения авторских прав. 
                  Вся ответственность за законность материалов лежит на пользователе, их загрузившем. 
                  Платформа действует по принципу "notice and takedown" — удаляет материал после 
                  получения обоснованной жалобы.
                </p>
              </div>

              <p className="font-semibold text-foreground mt-4">
                7.4. Кнопка "Пожаловаться на нарушение"
              </p>
              <p>
                На странице каждой работы доступна кнопка для отправки жалобы. Используйте её, 
                если обнаружили пиратский контент или нарушение ваших прав. Анонимные жалобы 
          ...
          <Card className="border-2 border-primary/30">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                11. Реквизиты и контакты Исполнителя
              </CardTitle>
            </CardHeader>
