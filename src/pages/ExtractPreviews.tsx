      ...
      <div className="max-w-4xl mx-auto">
        <Card className="p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold">Извлечение превью из ZIP архивов</h1>
          </div>

          <div className="mb-6">
            <p className="text-gray-700 mb-2">
              Эта функция автоматически извлечет первый PNG файл из каждого ZIP архива и создаст превью для работ.
            </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-900">
                ...
                <ul className="list-disc list-inside space-y-1 text-blue-800">
                  ...
                  <li>Открывает каждый ZIP архив в Object Storage</li>
