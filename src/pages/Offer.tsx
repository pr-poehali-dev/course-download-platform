              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    обмена инженерными материалами между авторами и пользователями. Платформа не создает контент и не несет 
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Доступ к платформе Tech Forma для поиска и обмена инженерными материалами</li>
                <li>Возможность загрузки собственных материалов</li>
                <li>Доступ к скачиванию материалов других пользователей за баллы</li>
