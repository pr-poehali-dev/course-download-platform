...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '1 балл = 5 рублей при покупке пакетов. Баллы можно пополнить картой в разделе "Баланс", заработать за загрузку своих работ или получить по реферальной программе (600 баллов за каждого реферала).'
  },
  {
