    ...
    <div className="container max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-muted-foreground">
            <p>
              Tech Forma — это техническая библиотека для обмена образовательными материалами (чертежи, 3D-модели, технические расчёты, проектная документация, примеры учебных проектов).
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-muted-foreground">
            ...
            <p><strong>3.5.</strong> Платформа предназначена для лиц старше 18 лет.</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-muted-foreground">
            ...
            <p><strong>7.3.</strong> Получая материал, вы получаете право на изучение и использование как справочного пособия. Прямое копирование запрещено.</p>
